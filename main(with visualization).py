...
querry_selector_1 = """SELECT ROUND(AVG(mileage), 2) as avg_miles, engine_type 
FROM Cars INNER JOIN Engine_Type USING(engine_id)
GROUP BY engine_type
ORDER BY avg_miles"""

querry_selector_2 = """SELECT COUNT(engine_id) as amount, engine_type
FROM Cars INNER JOIN Engine_Type USING(engine_id)
GROUP BY engine_type
ORDER BY amount"""

querry_selector_3 = """SELECT COUNT(cust_id) as amount, cust_age 
